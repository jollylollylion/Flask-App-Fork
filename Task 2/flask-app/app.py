...
# Anything after the @ is the name of your container DNS name
# After the 3306/ is your database name
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:password@flask-db:3306/flask-db'
